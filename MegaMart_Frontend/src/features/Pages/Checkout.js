...
import { DeleteItemFromCartAsync, addToCartAsync, increment, selectItems, updateCartAsync } from "../cart/cartSlice";
  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="lg:col-span-3 ">
        <form className="bg-white px-4 py-4 rounded-md" noValidate onSubmit={handleSubmit((data)=>{
                console.log(data);
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <ul role="list">
      {Array.isArray(userInfo.addresses) && userInfo.addresses.map((address,index) => (
        <li key={index} className="flex justify-between gap-x-6 py-5 px-4 border-solid border-2 border-gray-200 mt-2">
      ...
      <div className="mx-auto mt-12 mb-0 pt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8 w-5/5 rounded-xl">
          ...
          <div className="border-t border-gray-200 px-12 py-7 sm:px-8">
            <div className="flex justify-between text-base font-medium text-gray-900">
              <p>Subtotal</p>
              <p>${totalAmount}</p>
            </div>
