      ...
      <div>
        <div>
          <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <button
            onClick={e=>{setShowAddAddressForm(!showAddAddressForm);setSelectedEditIndex(-1);reset();}}
            type="submit"
            className="rounded-md my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
          >
            Add New Address
          </button>
          {showAddAddressForm ? (
