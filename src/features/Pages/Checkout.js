  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="lg:col-span-3 ">
        <form className="bg-white px-4 py-4 rounded-md">
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 py-5 px-4 border-solid border-2 border-gray-200 mt-2">
          ...
          <div className="hidden sm:flex sm:flex-col sm:items-end">
            <p className="text-sm leading-6 text-gray-900">Phone : {address.phoneNo}</p>
      ...
      <div className="lg:col-span-2">
        <div className=" flex flex-col h-screen justify-center items-center ">
          <div className=" mt-6 ml-5   bg-white max-w-7xl px-4 sm:px-6 lg:px-8  w-5/5 rounded-xl ">
