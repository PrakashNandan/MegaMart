...
function Checkout() {
  ...
  return (
    <>
      ...
      {orederPlaced && orederPlaced.paymentMethod == "cash" && (
        <Navigate
          to={`/order-success/${orederPlaced.id}`}
          replace={true}
        ></Navigate>
      )}
      {orederPlaced && orederPlaced.paymentMethod == "card" && (
        <Navigate
          to={`/stripe-checkout/`}
          replace={true}
        ></Navigate>
            ...
            >
              <div className="space-y-12">
                ...
                <div className="border-b border-gray-900/10 pb-12">
                  ...
                  <ul role="list">
                    {Array.isArray(userInfo.addresses) &&
                      userInfo.addresses.map((address, index) => (
                        <li
                          key={index}
                          className="flex justify-between gap-x-6 py-5 px-4 border-solid border-2 border-gray-200 mt-2"
                        >
